...
- [ ] Create `docs/COMPONENTS.md` (Section list, UI components, animations, props/hydration)
- [ ] Create `docs/STYLING.md` (Tailwind v4, brand colors, typography, custom utilities, CSS variables)
